...
const Card =({name,email,id,number,depart,arrive,prix,date,hd,ha})=>{
  ...
  return (
   <div className=' center bg-light-green br3 ma2 grow  shadow-5' style={{width:'65%'}}> 
  ...
  <p className="ml6">🔼 {hd} </p>
  </div>
    <div className='z'>
    <p><span className="img_user">🛫</span> {depart}</p>
    ...
    <p className="ml6">🔽 {ha} </p>
  </div>
    <div className='e'>
    <p> <span className="img_user">🛬 </span>{arrive}</p>

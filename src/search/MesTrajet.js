...
const MesTrajet =({name,email,id,number,depart,arrive,prix,date,hd,ha,onPayment,bagage,nbrplacedispo,typevehicule,confortvoiture,myId})=>{
   ...
   <div className='pa2 center bg-light-green br3 ma2 grow  shadow-5' style={{width:'65%', height:'310px'}}> 
    <div style={{width:'100%', height:'33.70%'}} className='flex'>
      <div style={{width:'15%', height:'100%'}}>
        <img alt='robots' src={`https://robohash.org/${myId}?2000*200`} className='img_user' height="100px" width="100px"/>
      </div>
    ...
    <div style={{width:'100%', height:'26.96%'}} className='flex'>
      ...
      <div style={{width:'33%', height:'100%'}}>
        <p className='f3 pa3 gray b'>{prix} DH</p>
      </div>
    </div>
    <div style={{width:'100%', height:'19.10%'}} className=''>
      <div style={{width:'97%',display:'flex',justifyContent:'flex-end',marginTop:'1%'}} className='pv3'>
        <button className="bt br4 ph3 pv1  ba black  grow pointer ">Chatter avec les conducteur</button>
        <button className="bt br4 ph3 pv1  ba black  grow pointer ">Supprimer le trajet</button>
      </div>
    </div>
